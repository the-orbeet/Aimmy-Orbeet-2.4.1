...
<p>Fork of  <a href="https://github.com/Babyhamsta/Aimmy" target="_blank">Aimmy V2.4.1 by BabyHamsta</a> just with some cool Features like Arduino Support wit Auto Com Port Detection (multilingual) and a sticky ESP Head Marker, more Features in work.</p>
<h2>Changelog</h2>
