...
namespace InputLogic
{
    internal class InputBindingManager
    {
        ...
        {
            // >>> Wichtig für Arduino/Simulations-Schutz:
            // Simulierte Klicks (aus MouseManager) ignorieren,
            // damit keine Feedback-Schleifen entstehen.
            if (MouseManager.isSendingInput)
                return;
        ...
        {
            // >>> Gegenstück zum Down-Ignore für simulierte Klicks
            if (MouseManager.isSendingInput)
                return;
